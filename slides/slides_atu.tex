...
\setbeamertemplate{frametitle}{%
    \vspace{3mm} \leavevmode
    \hfill {\normalsize \color{black} \insertframenumber } \hspace{5mm}%
    \vspace{-7mm}
...
\begin{frame}
  ...
  %Відсутня індивідуальна динаміка кожного
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item
      ...
      % Може поєднувати функції вхідного і вихідного сигналів.

    \item
      $q_c(t)$ ---
      значення критерію якості;
      % (аналогічно попередньої величиною в
    ...
    \item
      ...
      $p_e(t)$.
      % Якщо агент не використовує для роботи апроксимацію
...
\begin{frame}
  ...
  \begin{figure}[htb!]
    \begin{center}
      \includegraphics[width=40\TW]{../p6/p/mod/colp_scheme.pdf}
    \end{center}
